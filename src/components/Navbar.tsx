            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" to="/pages/register">Register</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/pages/profile">Profile</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/pages/messaging">Messages</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/pages/projects">Projects</Link>
                        </li>
                    </ul>
                </div>
            </div>
