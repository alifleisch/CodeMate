...
export const mockTopics: Topic[] = [
    ...
    },
    {
        ...
        posts: [
            { id: 1, author: "User7", content: "Flutter's hot reload feature is a game-changer.", owner: "User7", timestamp: "2023-01-07" },
            { id: 2, author: "User8", content: "React Native allows for great cross-platform development.", owner: "User8", timestamp: "2023-01-08" },
        ],
    },
    {
        id: 5,
